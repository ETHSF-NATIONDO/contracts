...
bytes32 constant AGREEMENT_HASH = keccak256("Agreement(address active, address passive, string uri");

contract ERC4973 is IERC4973, EIP712, ERC165, IERC721Metadata {
